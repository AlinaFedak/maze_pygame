...
class Player(GameSprite):
    def update(self):
        ...
        if keys_pressed[K_RIGHT] and self.rect.x < win_width - 80: #1235
            self.rect.x += self.speed
        if keys_pressed[K_UP] and self.rect.y > 5:
            self.rect.y -= self.speed
        if keys_pressed[K_DOWN] and self.rect.y < win_height -80: #745:
            self.rect.y += self.speed
...
player = Player('hero.png', x1, y1, 4)
enemy = Enemy('enemy4.png', x2, y2, 1)
enemy2 = Enemy('eneemy1.png', x4, y4, 1)
enemy3 = Enemy('eneemy3.png', x5, y5, 1)
treasure = GameSprite('coin.png', x3, y3, 0)
key_pic = GameSprite('key_pic.png', x6, y6, 0)

mixer.init()
mixer.music.load('gamemusic.ogg')
mixer.music.play()

money = mixer.Sound('money (1).ogg')
...
while game:
    ...
    if sprite.collide_rect(player, key_pic):
        ...
        key_pic = GameSprite('key_pic.png', 1, 1000, 0)
        key_sound.play()
